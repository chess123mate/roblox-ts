...
class TransformState {
    ...
    constructor(program, data, services, pathTranslator, multiTransformState, compilerOptions, rojoResolver, pkgRojoResolvers, nodeModulesPathMapping, runtimeLibRbxPath, typeChecker, projectType, sourceFile) {
        ...
        this.varArgsStack = new Array();
        this.declarationToOptimizableVarArgs = new Map();
    ...
    pushFunction(varArgs) {
        this.varArgsStack.push(varArgs !== null && varArgs !== void 0 ? varArgs : false);
        if (varArgs) {
    ...
    getOptimizableVarArgsData(id) {
        var _a;
        const valueDeclaration = (_a = this.typeChecker.getSymbolAtLocation((0, traversal_1.skipDownwards)(id))) === null || _a === void 0 ? void 0 : _a.valueDeclaration;

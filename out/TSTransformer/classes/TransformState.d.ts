...
export declare class TransformState {
    ...
    private readonly varArgsStack;
    private readonly declarationToOptimizableVarArgs;
    pushFunction(varArgs: VarArgsData | undefined): void;
    popFunction(): void;
    getOptimizableVarArgsData(id: ts.Expression): VarArgsData | undefined;
}

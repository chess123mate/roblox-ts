...
export declare function tryHandleVarArgsIndexableExpression(state: TransformState, node: ts.ElementAccessExpression, elementIndexExpr: luau.Expression): luau.ParenthesizedExpression | undefined;

...
export declare function tryHandleVarArgsIndexableExpression(state: TransformState, node: ts.ElementAccessExpression, indexExpr: luau.Expression): luau.ParenthesizedExpression | undefined;

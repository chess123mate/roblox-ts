...
function transformClassConstructor(state, node, name) {
    const { statements, parameters, hasDotDotDot, varArgsData } = (0, transformParameters_1.transformParameters)(state, node);
    ...
    const result = luau_ast_1.default.list.make(luau_ast_1.default.create(luau_ast_1.default.SyntaxKind.MethodDeclaration, {
        expression: name,
        name: CONSTRUCTOR,
        statements,
        parameters,

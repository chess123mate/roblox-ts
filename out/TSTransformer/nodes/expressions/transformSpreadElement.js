...
function transformSpreadElement(state, node) {
    ...
    if ((0, types_1.isDefinitelyType)(type, (0, types_1.isArrayType)(state))) {
        return (_a = (0, varArgsOptimization_1.tryHandleVarArgsArraySpread)(state, node)) !== null && _a !== void 0 ? _a : luau_ast_1.default.call(luau_ast_1.default.globals.unpack, [expression]);
    }
    else {

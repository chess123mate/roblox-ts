...
function transformFunctionExpression(state, node) {
    ...
    let { statements, parameters, hasDotDotDot, varArgsData } = (0, transformParameters_1.transformParameters)(state, node);
    ...
    if (node.asteriskToken) {
        ...
        statements = (0, wrapStatementsAsGenerator_1.wrapStatementsAsGenerator)(state, node, statements, hasDotDotDot);
    }
